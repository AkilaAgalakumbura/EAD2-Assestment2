	...
	<div class="container col-md-5">
		<div class="card">
			<div class="card-body">
				...
				<c:if test="${user != null}">
					<input type="hidden" name="NIC" value="<c:out value='${user.NIC}' />" />
				</c:if>
				...
				<fieldset class="form-group">
					<label>User Joined Date</label> <input type="text"
						value="<c:out value='${user.Joined Date}' />" class="form-control"
						name="country">
				</fieldset>
